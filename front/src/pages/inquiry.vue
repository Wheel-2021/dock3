      ...
      <div class="p-6">
        <form @submit.prevent="submit">
          ...
          <div class="mt-4">
            ...
            <textarea
              id="contents"
              class="block w-full h-48 px-4 py-2 mt-2 text-gray-700 bg-input border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring"
              placeholder="例) 問い合わせ"
              aria-label="Textarea"
              name="contents"
              v-model="contents"
